define [
  ...
  Marionette.Region.prototype.show = (view, options) ->
    ...
    if _shouldDestroyView
      @empty()
    else if isChangingView and _shouldShowView
      @currentView.off 'destroy', @empty, @
    ...
    if _shouldShowView
      ...
      if isChangingView
        @triggerMethod 'before:swap', view, @, options
      ...
      if isChangingView
        @triggerMethod 'swapOut', @currentView, @, options

      @currentView = view

      if isChangingView
        @triggerMethod 'swap', view, @, options

      @triggerMethod 'show', view, @, options
      Marionette.triggerMethodOn view, 'show', view, @, options
